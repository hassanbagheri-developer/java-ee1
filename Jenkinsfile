        ...
        stage('JIRA') {
            steps {
              script {
                ...
                sh 'zip  ${JOB_NAME}_${BUILD_NUMBER}.zip /root/.jenkins/jobs/Document-java-ee1/builds/${BUILD_NUMBER}/log /root/.jenkins/workspace/Document-java-ee1/target/firstWeb.war '
                jiraUploadAttachment file: "${JOB_NAME}_${BUILD_NUMBER}.zip", idOrKey: 'PROJ-38', site: 'jira'
                }
            }
        }
    }
